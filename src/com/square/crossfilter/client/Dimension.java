...
public class Dimension<T, K> extends JavaScriptObject {
    ...
    public static abstract class IntFilter extends Filter<Integer> {
        ...
        private final native JavaScriptObject f() /*-{
            var self = this;
            return function(v) {
                return self.@com.square.crossfilter.client.Dimension.IntFilter::filter(I)(v);
            };
        }-*/;
    }
    ...
    public static abstract class StringFilter extends Filter<String> {
        ...
        private final native JavaScriptObject f() /*-{
            var self = this;
            return function(v) {
                return self.@com.square.crossfilter.client.Dimension.StringFilter::filter(Ljava/lang/String;)(v);
            };
        }-*/;
    }
    ...
    public static abstract class IntReducer<T> extends Reducer<T, Integer> {
        ...
        private final native JavaScriptObject f() /*-{
			var self = this;
			return function(v) {
				return self.@com.square.crossfilter.client.Dimension.IntReducer::getValue(Ljava/lang/Object;)(v);
			};
        }-*/;
    }
    ...
    public static abstract class DoubleReducer<T> extends Reducer<T, Double> {
        ...
        private final native JavaScriptObject f() /*-{
			var self = this;
			return function(v) {
				return self.@com.square.crossfilter.client.Dimension.DoubleReducer::getValue(Ljava/lang/Object;)(v);
			};
        }-*/;
    }
    ...
    public static abstract class StringReducer<T> extends Reducer<T, String> {
        ...
        private final native JavaScriptObject f() /*-{
			var self = this;
			return function(v) {
				return self.@com.square.crossfilter.client.Dimension.StringReducer::getValue(Ljava/lang/Object;)(v);
			};
        }-*/;
    }
    ...
    public static abstract class DateReducer<T> extends Reducer<T, Date> {
        ...
        private JsDate getTime(T object) {
            return CrossfilterUtil.toJs(getValue(object));
        }

        private final native JavaScriptObject f() /*-{
			var self = this;
			return function(v) {
				return self.@com.square.crossfilter.client.Dimension.DateReducer::getTime(Ljava/lang/Object;)(v);
			};
        }-*/;
    }
    ...
    public static abstract class ObjectReducer<T, V> {
        ...
        protected final native JavaScriptObject reduceAdd() /*-{
			var self = this;
			return function(a, b) {
				return self.@com.square.crossfilter.client.Dimension.ObjectReducer::reduceAdd(Ljava/lang/Object;Ljava/lang/Object;)(a,b);
			};
        }-*/;
        ...
        protected final native JavaScriptObject reduceRemove() /*-{
			var self = this;
			return function(a, b) {
				return self.@com.square.crossfilter.client.Dimension.ObjectReducer::reduceRemove(Ljava/lang/Object;Ljava/lang/Object;)(a,b);
			};
        }-*/;
        ...
        protected final native JavaScriptObject reduceInitialJs() /*-{
			var self = this;
			return function() {
				return self.@com.square.crossfilter.client.Dimension.ObjectReducer::reduceInitial()();
			};
        }-*/;
    }
    ...
    public static abstract class IntGrouping extends Grouping<Integer> {
        ...
        private final native JavaScriptObject f() /*-{
			var self = this;
			return function(v) {
				return self.@com.square.crossfilter.client.Dimension.IntGrouping::getGroup(I)(v);
			};
        }-*/;
    }
    ...
    public static abstract class DoubleGrouping extends Grouping<Double> {
        ...
        private final native JavaScriptObject f() /*-{
			var self = this;
			return function(v) {
				return self.@com.square.crossfilter.client.Dimension.DoubleGrouping::getGroup(D)(v);
			};
        }-*/;
    }
    ...
    public static abstract class StringGrouping extends Grouping<String> {
        ...
        private final native JavaScriptObject f() /*-{
			var self = this;
			return function(v) {
				return self.@com.square.crossfilter.client.Dimension.StringGrouping::getGroup(Ljava/lang/String;)(v);
			};
        }-*/;
    }
    ...
    public static abstract class DateGrouping extends Grouping<Date> {
        ...
        private JsDate getGroup(JsDate value) {
            return CrossfilterUtil.toJs(getGroup(CrossfilterUtil.toGWT(value)));
        }
        ...
        private final native JavaScriptObject f() /*-{
			var self = this;
			return function(v) {
				return self.@com.square.crossfilter.client.Dimension.DateGrouping::getGroup(Lcom/google/gwt/core/client/JsDate;)(v);
			};
        }-*/;
    }
    ...
    public final native Dimension<T, K> filterFunction(final Filter<K> filter) /*-{
		return this
				.filterFunction(filter.@com.square.crossfilter.client.Dimension.Filter::getFunction()());
    }-*/;
