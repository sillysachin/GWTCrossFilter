...
import com.square.crossfilter.client.Dimension.ObjectReducer;
import com.square.crossfilter.client.Dimension.Reducer;
...
public class Group<T, K> extends JavaScriptObject {
    ...
    public final native Group<T, K> reduceCount() /*-{
     ...
     public final native <V> Group<T, K> reduceSum(final Reducer<T, V> type) /*-{
         return this.reduceSum(type.@com.square.crossfilter.client.Dimension.Reducer::getFunction()());
     }-*/;
    ...
    public final native <V> Group<T, K> reduce(ObjectReducer<T, V> reducer) /*-{
		return this
				.reduce(
						reducer.@com.square.crossfilter.client.Dimension.ObjectReducer::reduceAdd()(),
						reducer.@com.square.crossfilter.client.Dimension.ObjectReducer::reduceRemove()(),
						reducer.@com.square.crossfilter.client.Dimension.ObjectReducer::reduceInitialJs()());
    }-*/;
